...
export type GetDashboardStatsOutput = {
  ...
  totalAccessPolicies: Scalars['Int']['output'];
...
export type GetDashboardStatsQuery = { getDashboardStats: { data: { totalUsers: number, activeUsers: number, totalAccessPolicies: number } } };
