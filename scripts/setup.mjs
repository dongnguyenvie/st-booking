...
log('  +----------------------------+-------------------------+--------------+');
log('  | admin@carousel-marketplace.dev         | Admin@2026!Secure       | Super Admin  |');
log('  | pos-manager@carousel-marketplace.dev   | PosManager@2026!Secure  | POS Manager  |');
log('  | pos-user@carousel-marketplace.dev      | PosCashier@2026!Secure  | POS Cashier  |');
log('  +----------------------------+-------------------------+--------------+');
log('');
