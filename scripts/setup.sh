...
echo "  ├────────────────────────────┼─────────────────────────┼──────────────┤"
echo "  │ admin@carousel-marketplace.dev         │ Admin@2026!Secure       │ Super Admin  │"
echo "  │ pos-manager@carousel-marketplace.dev   │ PosManager@2026!Secure  │ POS Manager  │"
echo "  │ pos-user@carousel-marketplace.dev      │ PosCashier@2026!Secure  │ POS Cashier  │"
echo "  └────────────────────────────┴─────────────────────────┴──────────────┘"
echo ""
